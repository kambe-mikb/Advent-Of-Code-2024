...
var day09Cmd = &cobra.Command{
	Use:   "day09",
	Short: "Day 9: Disk Fragmenter",
	Long: `Another push of the button leaves you in the familiar hallways of
some friendly amphipods! Good thing you each somehow got your own personal
...
`
		inputFile = "input09.txt"
	},
	PersistentPostRun: rootCmd.Run,
}

// day09part1Cmd represents the part1 command
var day09part1Cmd = &cobra.Command{
	Use:   "part1",
	Short: "Part 1 of Advent of Code Day 09",
	Long:  "What is the resulting filesystem checksum?",
	Run: func(cmd *cobra.Command, args []string) {
		solution = day09part1
	},
	PostRun: day09Cmd.Run,
}

// day09part2Cmd represents the part2 command
var day09part2Cmd = &cobra.Command{
	Use:   "part2",
	Short: "Part 2 of Advent of Code Day 09",
	Long:  "What is the resulting filesystem checksum?",
	Run: func(cmd *cobra.Command, args []string) {
		solution = day09part2
	},
...
func init() {
	...
	day09Cmd.AddCommand(day09part1Cmd)
	day09Cmd.AddCommand(day09part2Cmd)
}
