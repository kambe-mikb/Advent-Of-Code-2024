...
var day08Cmd = &cobra.Command{
	Use:   "day08",
	Short: "Day 8: Resonant Collinearity",
	Long: `You find yourselves on the roof of a top-secret Easter Bunny installation.
...
that for any pair of antennas with the same frequency, there are two
...
............
............`
		inputFile = "input08.txt"
	},
	PersistentPostRun: rootCmd.Run,
}

// day08part1Cmd represents the part1 command
var day08part1Cmd = &cobra.Command{
	Use:   "part1",
	Short: "Part 1 of Advent of Code Day 08",
	Long:  "How many unique locations within the bounds of the map contain an antinode?",
	Run: func(cmd *cobra.Command, args []string) {
		solution = day08part1
	},
	PostRun: day08Cmd.Run,
}

// day08part2Cmd represents the part2 command
var day08part2Cmd = &cobra.Command{
	Use:   "part2",
	Short: "Part 2 of Advent of Code Day 08",
	Long:  "How many unique locations within the bounds of the map contain an antinode?",
	Run: func(cmd *cobra.Command, args []string) {
		solution = day08part2
	},
...
func init() {
	...
	day08Cmd.AddCommand(day08part1Cmd)
	day08Cmd.AddCommand(day08part2Cmd)
}
